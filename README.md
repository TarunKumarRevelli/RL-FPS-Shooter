...
|--------------------|---------------------------|
| ![Training the agent](images/image.png) | ![PPO vs SAC Average Reward](images/image-1.png) |

| Critic/Value Loss Comparison | Policy Entropy |
|------------------------------|----------------|
| ![Critic/Value loss comparison between PPO and SAC](images/image-2.png) | ![Policy Entropy](images/image-3.png) |
